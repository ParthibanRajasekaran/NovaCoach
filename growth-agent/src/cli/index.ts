...
function buildParser(argv: string[]): Argv<unknown> {
  return yargs(argv)
...
const discoverCommand: CommandModule = {
  ...
  handler: async (rawArgs) => {
    const args = rawArgs as ArgumentsCamelCase<DiscoverCommandArgs>;
    await runDiscover({
...
const draftCommand: CommandModule = {
  command: 'draft',
  ...
  handler: async (rawArgs) => {
    const args = rawArgs as ArgumentsCamelCase<DraftCommandArgs>;
    await runDraft({
      locale: args.locale,
      query: args.query,
...
const prCommand: CommandModule = {
  ...
  handler: async (rawArgs) => {
    const args = rawArgs as ArgumentsCamelCase<PrCommandArgs>;
    await runPr({
      locale: args.locale,
...
const reportCommand: CommandModule = {
  ...
  handler: async (rawArgs) => {
    const args = rawArgs as ArgumentsCamelCase<ReportCommandArgs>;
    await runReport({
