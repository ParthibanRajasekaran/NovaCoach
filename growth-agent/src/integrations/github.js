...
export async function getGitAuthToken() {
...
async function resolveAuthToken() {
    ...
    throw new Error('Missing GitHub credentials. Set GITHUB_TOKEN or the GitHub App trio (GITHUB_APP_ID, GITHUB_INSTALLATION_ID, GITHUB_PRIVATE_KEY).');
}
function isInstallationAuth(value) {
